...
const { createInitialPayroll } = require('./payrollController');
...
const registerUser = async (req, res) => {
  ...
  try {
    ...
    if (user) {
      // Auto-generate payroll for the current month
      await createInitialPayroll(user._id);
...
module.exports = { registerUser, loginUser, getNextEmployeeId };
